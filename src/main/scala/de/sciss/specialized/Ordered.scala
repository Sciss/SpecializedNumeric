// same as scala.math.Ordered, however without java.util.Comparable, and specialized
 ...
 */
trait Ordered[@specialized(Int, Float, Long, Double) A] /* extends java.lang.Comparable[A] */ {
