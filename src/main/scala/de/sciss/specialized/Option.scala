//// same as scala's default Option, however specialized
...
//   */
//  def apply[@specialized(Int, Float, Long, Double, Boolean) A](x: A): Option[A] = if (x == null) None else Some(x)
//
...
// *  @define f `f`
// */
//sealed trait /* abstract class */ Option[@specialized(Int, Float, Long, Double, Boolean) +A] extends Product with Serializable {
//  self =>
//
...
//   */
//  def getOrElse[@specialized(Int, Float, Long, Double, Boolean) B >: A](default: => B): B =
...
//   * }}}
//   */
//  def orNull[@specialized(Int, Float, Long, Double, Boolean) A1 >: A](implicit ev: Null <:< A1): A1 = this getOrElse null
//
...
// */
//final case class Some[@specialized(Int, Float, Long, Double, Boolean) +A](x: A) extends Option[A] {
//  def isEmpty = false
//  def get = x
//}
//
